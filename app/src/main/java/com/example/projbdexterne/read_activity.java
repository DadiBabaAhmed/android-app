...
public class read_activity extends AppCompatActivity {
    ...
    class ReadData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            JSONObject object = parser.makeHttpRequest("http://10.0.2.2/php/AndroidProject/api/fetch_etudiant.php", "GET", params);
                ...
                if (object != null) {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; i < etudiants.length(); i++) {
                            ...
                            // Create a HashMap to hold values for a single item
                            ...
                            // Add this item to the values ArrayList
                            values.add(map);
                        }
                    } else {
                    ...
                    // Handle the case when the JSONObject is null or parsing fails
                    result = "No data received from the server.";
                }
            } catch (JSONException e) {
                e.printStackTrace();
                result = "Error parsing data: " + e.getMessage();
            }
